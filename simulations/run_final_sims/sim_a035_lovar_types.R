...
write.csv(type.summ.all, na = '', row.names = FALSE,
          file = 'simulations/outputs/final_results/a035_lovar_type_all.csv')
...
write.csv(type.summ.ext, na = '', row.names = FALSE,
          file = 'simulations/outputs/final_results/a035_lovar_type_ext.csv')
...
write.csv(type.summ.gen, na = '', row.names = FALSE,
          file = 'simulations/outputs/final_results/a035_lovar_type_gen.csv')
