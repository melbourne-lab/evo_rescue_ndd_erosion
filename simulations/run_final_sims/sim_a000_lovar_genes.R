...
write.csv(gene.summ.all, na = '', row.names = FALSE,
          file = 'simulations/outputs/final_results/a000_lowvar_gene_all.csv')
...
write.csv(gene.summ.ext, na = '', row.names = FALSE,
          file = 'simulations/outputs/final_results/a000_lowvar_gene_ext.csv')
...
write.csv(gene.summ.gen, na = '', row.names = FALSE,
          file = 'simulations/outputs/final_results/a000_lowvar_gene_gen.csv')
