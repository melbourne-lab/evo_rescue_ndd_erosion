...
write.csv(all.sims, row.names = FALSE,
          file = "simulations/outputs/alldata_n20_a035_hivar.csv")

# sessionInfo()

# session info 1 Oct. 2022
# NOTE: this was run through RStudio on ubuntu server due to mysterious
# tidyverse environment error (for this script only) when running through cmd
...
#   [1] tidyselect_1.1.1 tidyr_1.1.3      dplyr_1.0.7     
# [4] ggplot2_3.3.5   
# 
# loaded via a namespace (and not attached):
#   [1] fansi_0.5.0      withr_2.4.2      crayon_1.4.1    
# [4] utf8_1.2.2       grid_4.1.2       R6_2.5.0        
# [7] lifecycle_1.0.0  gtable_0.3.0     magrittr_2.0.1  
# [10] scales_1.1.1     pillar_1.6.2     rlang_0.4.11    
# [13] cli_3.0.1        rstudioapi_0.13  generics_0.1.0  
# [16] vctrs_0.3.8      ellipsis_0.3.2   tools_4.1.2     
# [19] glue_1.4.2       purrr_0.3.4      munsell_0.5.0   
# [22] compiler_4.1.2   pkgconfig_2.0.3  colorspace_2.0-2
# [25] tibble_3.1.3    
