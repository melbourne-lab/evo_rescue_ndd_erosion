...
# adapted from simulations/run_final_simulations/test_alldata_n20_a000_lovar.R
...
for (i in 1:nrow(pars)) {
  ...
  print(paste0('did 20 lo var ', i, ' of ', nrow(pars)))
}
...
write.csv(all.sims, row.names = FALSE,
          file = "simulations/outputs/alldata_n20_a000_lowvar.csv")
