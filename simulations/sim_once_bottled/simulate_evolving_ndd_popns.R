...
# adapted and run on July 7 2020
...
write.csv(all.n.summ, na = '', row.names = FALSE,
          file = 'simulations/outputs/a035_evotrue_all_n.csv')
...
write.csv(all.demo.summs, na = '', row.names = FALSE,
          file = 'simulations/outputs/a035_evotrue_all_demo.csv')
...
write.csv(all.gene.summs, na = '', row.names = FALSE,
          file = 'simulations/outputs/a035_evotrue_all_gene.csv')
