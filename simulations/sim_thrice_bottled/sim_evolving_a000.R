...
write.csv(all.demo.summs, na = '', row.names = FALSE,
          file = 'simulations/outputs/thrice_bottlenecked_results/a000_evotrue_all_demo.csv')
...
write.csv(all.gene.summs, na = '', row.names = FALSE,
          file = 'simulations/outputs/thrice_bottlenecked_results/a000_evotrue_all_gene.csv')
