...
# In this script: high genetic variation (bottlenecks), density dependent.
...
write.csv(type.summ.all, na = '', row.names = FALSE,
          file = 'simulations/outputs/thrice_bottlenecked_results/a035_hivar_type_all.csv')
...
write.csv(type.summ.ext, na = '', row.names = FALSE,
          file = 'simulations/outputs/thrice_bottlenecked_results/a035_hivar_type_ext.csv')
...
write.csv(type.summ.gen, na = '', row.names = FALSE,
          file = 'simulations/outputs/thrice_bottlenecked_results/a035_hivar_type_gen.csv')
